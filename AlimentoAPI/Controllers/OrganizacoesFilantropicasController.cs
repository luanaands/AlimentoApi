...
{
    [RoutePrefix("v1/OrganizacoesFilantropicas")]
    public class OrganizacoesFilantropicasController : ApiController
    {

        public IOrganizacoesFilantropicasServico instituicaoServico { get; set; }
        ...
        [HttpPost]
        [Route("Adicionar")]
        public object Adicionar(OrganizacoesFilantropicas objecto)
        {
            try
            {
